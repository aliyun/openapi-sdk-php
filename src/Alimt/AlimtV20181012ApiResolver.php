 ...
 *
 * @method V20181012\TranslateECommerce translateECommerce(array $options = [])
 * @method V20181012\TranslateGeneral translateGeneral(array $options = [])
 */
class AlimtV20181012ApiResolver
{
