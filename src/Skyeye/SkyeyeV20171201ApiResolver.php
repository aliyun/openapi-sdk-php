 ...
 *
 * @method V20171201\GetCdnSkyeyeStatusData getCdnSkyeyeStatusData(array $options = [])
 * @method V20171201\SendAlertContent sendAlertContent(array $options = [])
 */
class SkyeyeV20171201ApiResolver
{
