[← 先决条件](/docs/zh/0-Prerequisites.md) | 安装[(English)](/docs/en/1-Installation.md) | [客户端 →](https://github.com/aliyun/openapi-sdk-php-client/blob/master/docs/zh/2-Client.md)
***
...
在安装之前，请确保您的环境使用的是 PHP 5.5 或更高版本。了解有关[环境要求和建议的更多信息](/docs/zh/0-Prerequisites.md)。
